...
write(avgX, "avgX.txt")
plot(x, y)
abline(a, b, col = "orange", lwd = 2)
dev.print(pdf, "nifty_plot.pdf")
dev.print(png, "nifty_plot.png", width = 6, units = "in", res = 300)

list.files()
## notice that avgX.txt and niftyPlot.pdf have appeared in project directory
